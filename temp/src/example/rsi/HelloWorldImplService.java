 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://rsi.example/", wsdlLocation = "http://localhost:9999/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://rsi.example/", "HelloWorldImplService");
