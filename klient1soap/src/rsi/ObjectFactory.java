 ...
 * generated in the example.rsi package. 
 * <p>An rsi.ObjectFactory allows you to programatically
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://rsi.example/", "getHelloWorldAsString");
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://rsi.example/", "getHelloWorldAsStringResponse");

    /**
     * Create a new rsi.ObjectFactory that can be used to create new instances of schema derived classes for package: example.rsi
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rsi.example/", name = "getHelloWorldAsString")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rsi.example/", name = "getHelloWorldAsStringResponse")
