 ...
 * 
 */
@WebServiceClient(name = "rsi.HelloWorldImplService", targetNamespace = "http://rsi.example/", wsdlLocation = "http://localhost:9999/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://rsi.example/", "rsi.HelloWorldImplService");
     ...
     * 
     * @return
     *     returns rsi.HelloWorldInt
     */
    @WebEndpoint(name = "HelloWorldImplPort")
    public HelloWorldInt getHelloWorldImplPort() {
        return super.getPort(new QName("http://rsi.example/", "HelloWorldImplPort"), HelloWorldInt.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloWorldImplPort")
    public HelloWorldInt getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://rsi.example/", "HelloWorldImplPort"), HelloWorldInt.class, features);
    }
